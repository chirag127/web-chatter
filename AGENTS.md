...
* **Type:** Web Browser Extension & Web Platform.
* **Language:** JavaScript (Presumed migrating to TypeScript for future-proofing).
* **Framework:** Vite (Bundling).
* **Extension Build Tool:** WXT (WebExtension ToolKit).
* **Testing:** Vitest (Unit/Integration), Playwright (E2E).
* **Linting/Formatting:** Biome.
* **Architecture:** Feature-Sliced Design (FSD) within the extension and platform.
